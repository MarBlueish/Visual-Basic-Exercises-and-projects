...
Partial Class AboutBox1
    ...
    Private Sub InitializeComponent()
        ...
        LabelProductName.Text = "FrontOffice Management"
        ...
        LabelVersion.Text = " Versão 0.0.1"
        ...
        LabelCompanyName.Text = "Infoware Software"
        ...
        TextBoxDescription.Text = "Este Software permite a adição de dados de novos clientes, tal como a limpeza dos mesmos. "
        ' 
        ' OKButton
        ' 
